...
static command_result fastdwarf2 (color_ostream &out, vector <string> & parameters)
{
...
{
    commands.push_back(PluginCommand("fastdwarf2",
        "enable/disable fastdwarf(parameters=0/1/2) and teledwarf (parameters=0/1)",
        fastdwarf2, false,
        "fastdwarf2: make dwarves faster.\n"
        "Usage:\n"
        "  fastdwarf2 <speed> (tele)\n"
